...
class BookDetailsSellerScreen extends StatelessWidget {
  ...
  const BookDetailsSellerScreen({Key? key, required this.bookPath}) : super(key: key);
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              ...
              textAlign: TextAlign.justify, // Optionally, add this line for justified text
            ...
            children: [
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  foregroundColor: const Color(0xFFE16A3D), backgroundColor: Colors.white, // Text color
                  side: const BorderSide(color: Color(0xFFE16A3D)), // Border color
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  foregroundColor: Colors.white, backgroundColor: const Color(0xFFE16A3D), // Text color
                  minimumSize: const Size(133, 33), // Button size
                ),
